...
@implementation EGPlayerTopCell
+(instancetype)cellWithUITableView:(UITableView *)tableView{
    
    static NSString *ID = @"EGPlayerTopCell";
    EGPlayerTopCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    if (cell == nil) {
          cell = [[EGPlayerTopCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];//class
...
- (void)setupWithInfo:(NSDictionary *)info {
    ...
    self.winrateLabel.text = [info objectForKey:@"BatterName"];
