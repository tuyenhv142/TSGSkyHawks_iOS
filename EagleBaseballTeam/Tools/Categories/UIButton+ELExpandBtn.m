...
@implementation UIButton (ELExpandBtn)
//扩大点击区域
                        ...
                        imageTitleSpace:(CGFloat)space
{
    ...
    switch (style) {
        ...
        case ZYButtonEdgeInsetsStyleRight:
        {
            ...
            // 假设button的size为button.width = imageWidth + spacing + titleWidth
            // 设置图片和文字之间的间距为10点
//            CGFloat spacing = 10.0;
//             
//            // 设置图片的EdgeInsets
//            button.imageEdgeInsets = UIEdgeInsetsMake(0, button.titleLabel.bounds.size.width + spacing, 0, 0);
//             
//            // 设置文字的EdgeInsets
//            button.titleEdgeInsets = UIEdgeInsetsMake(0, 0, 0, button.imageView.bounds.size.width + spacing);
        }
            break;
        default:
            break;
